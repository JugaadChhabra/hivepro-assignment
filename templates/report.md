...
- ⚠️ **Exposure:** inventory records this asset as internal-only, but a public object policy may make it reachable via the provider URL — verify before deprioritising.
{% endif %}
